...
namespace TableData
{
    ...
    public class EquippableItemData : IIdentifiable<int>
    {
        ...
        public EquippableItemData(int ID, ItemType ItemType, ItemQuality ItemQuality, int DropRate, string Price, int UpgradeCount, float Health, float Spirit, float Swift, float Haste, string PhysicalDamage, float PhysicalCritRate, float PhysicalCritDamage, float PhysicalAttackSpeed, float PhysicalPenetration, string MagicalDamage, float MagicalCritRate, float MagicalCritDamage, float MagicalAttackSpeed, float MagicalPenetration, float Armor, float Resistance, float Dodge)
        {
            this.ID = ID;
