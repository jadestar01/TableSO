...
{
    [System.Serializable]
    public class MaterialItemData : IIdentifiable<int>
    {
        ...
        [field: SerializeField] public MaterialType MaterialType { get; internal set; }

        [field: SerializeField] public int UpgradeRate { get; internal set; }
        ...
        public MaterialItemData(int ID, ItemType ItemType, ItemQuality ItemQuality, int DropRate, string Price, MaterialType MaterialType, int UpgradeRate, float Health, float Spirit, float Swift, float Haste, string PhysicalDamage, float PhysicalCritRate, float PhysicalCritDamage, float PhysicalAttackSpeed, float PhysicalPenetration, string MagicalDamage, float MagicalCritRate, float MagicalCritDamage, float MagicalAttackSpeed, float MagicalPenetration, float Armor, float Resistance, float Dodge)
        {
            this.ID = ID;
