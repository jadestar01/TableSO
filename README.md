...
3.  Enter the following URL and install the package:
    ```
    [https://github.com/jadestar01/TableSO.git?path=Packages/com.jadestar01.tableso#1.0.0](https://github.com/jadestar01/TableSO.git?path=Packages/com.jadestar01.tableso#1.0.0)
    ```
